...
const translations = {
  es: {
    ...
    'testimonials.item1.name': 'Andrea P.',
    'testimonials.item1.role': 'PM',
    'testimonials.item1.company': 'Startup Fintech',
    'testimonials.item1.quote': 'Julián es muy comprometido y mantiene una excelente comunicación. Entregó a tiempo y con calidad.',
    'testimonials.item2.name': 'Carlos R.',
    'testimonials.item2.role': 'CTO',
    'testimonials.item2.company': 'Agencia Web',
    'testimonials.item2.quote': 'Su enfoque en detalle y buenas prácticas nos ayudó a mejorar el rendimiento y la accesibilidad.',
    'testimonials.item3.name': 'María V.',
    'testimonials.item3.role': 'Founder',
    'testimonials.item3.company': 'E-Commerce',
    'testimonials.item3.quote': 'Propuso soluciones creativas y se adaptó rápidamente a cambios de alcance sin perder calidad.',
  ...
  en: {
    ...
    'testimonials.item1.name': 'Andrea P.',
    'testimonials.item1.role': 'PM',
    'testimonials.item1.company': 'Fintech Startup',
    'testimonials.item1.quote': 'Julián is highly committed and keeps excellent communication. Delivered on time and with quality.',
    'testimonials.item2.name': 'Carlos R.',
    'testimonials.item2.role': 'CTO',
    'testimonials.item2.company': 'Web Agency',
    'testimonials.item2.quote': 'His attention to detail and best practices helped us improve performance and accessibility.',
    'testimonials.item3.name': 'María V.',
    'testimonials.item3.role': 'Founder',
    'testimonials.item3.company': 'E-Commerce',
    'testimonials.item3.quote': 'He proposed creative solutions and quickly adapted to scope changes without losing quality.',
    'testimonials.item4.name': 'Diego S.',
    'testimonials.item4.role': 'Lead Dev',
