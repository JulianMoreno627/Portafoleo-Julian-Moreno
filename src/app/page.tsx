      ...
      <div className="w-full max-w-2xl mx-auto px-6 py-10">
        ...
        <div className="flex justify-center mb-8">
          <div className={`inline-block px-6 py-3 rounded-lg ${
            darkMode 
              ? "bg-[#2d3748]/60 backdrop-blur-sm" 
              : "bg-gray-200/60 backdrop-blur-sm"
          }`}>
            <p className="text-sm text-center">
              ¡Hola, soy un desarrollador independiente con sede en Colombia!
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-4xl font-bold mb-2">Julián Moreno</h1>
          ...
          <div className="flex-shrink-0">
            <div className="w-28 h-28 rounded-full overflow-hidden ring-4 ring-cyan-600/40">
              <Image
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-1">
            Trabajo
            <span className="block w-full h-[3px] bg-gray-700 mt-2"></span>
          </h2>
        ...
        <section>
          ...
          <div className="space-y-3 mt-4">
            ...
            >
              ...
              <span className="font-medium">@craftzdog</span>
            </a>
            ...
            >
              ...
              <span className="font-medium">@julian-moreno</span>
            </a>
